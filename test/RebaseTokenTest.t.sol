...
contract RebaseTokenTest is Test {
    ...
    function addRewardsToVault(uint256 rewardAmount) public {
        ...
        require(success, "Failed to send the rewards to the vault");
    }

    // fuzz test that will be moved to fuzz folder
    function testDepositLinear(uint256 amount) public {
        ...
        // 4. warp time once again by the same amount and check the balance again
        vm.warp(block.timestamp + 1 hours);
